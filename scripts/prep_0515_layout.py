...
def main():
    ...
    for prop in props:
        ...
        # 2. Symlink random_cv5 only — scaffold_cv5 is deprecated (replaced
        #    by scaffold_diverse_cv5 and scaffold_hybrid_cv5, which are real
        #    directories generated by scripts/{diverse,maxmin}_scaffold_split.py
        #    and not by this prep script).
        for split_kind in ("random_cv5",):
